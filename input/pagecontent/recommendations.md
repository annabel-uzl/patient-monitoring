...
1. **Create a [GitHub Issue](https://github.com/hl7-be/patient-monitoring)**  
   Describe the clinical need, scope, and stakeholders involved. Make sure your proposal follows the the legal requirements regarding transmural care.

2. **Validate with the Field**  
...
3. **Present to the HL7 Belgium Workgroup**  
