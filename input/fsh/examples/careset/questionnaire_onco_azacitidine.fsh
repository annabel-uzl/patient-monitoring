...
* item[nursingAssessment].item[=].item[+].linkId = "B5_OxygenSaturation"
* item[nursingAssessment].item[=].item[=].text = "Zuurstofsaturatie (enkel uitvoeren bij hoest en kortademigheid)"
* item[nursingAssessment].item[=].item[=].type = #decimal
* item[nursingAssessment].item[=].item[=].code = $loinc#2708-6 "Oxygen saturation in Arterial blood"
* item[nursingAssessment].item[=].item[=].extension.url = "http://hl7.org/fhir/StructureDefinition/questionnaire-unit"
* item[nursingAssessment].item[=].item[=].extension.valueCoding = $unitsofmeasure#% "%"
...
* item[nursingAssessment].item[=].item[+].linkId = "C4_OralIntake"
* item[nursingAssessment].item[=].item[=].text = "Geen orale intake (tgv verminderde eetlust of smaakverandering)"
* item[nursingAssessment].item[=].item[=].type = #choice
* item[nursingAssessment].item[=].item[=].required = true
* item[nursingAssessment].item[=].item[=].code = $sct#247318005 "Abnormal taste in mouth"
* item[nursingAssessment].item[=].item[=].answerOption[0].valueCoding = $sct#373066001 "Yes"
* item[nursingAssessment].item[=].item[=].answerOption[+].valueCoding = $sct#373067005 "No"

* item[nursingAssessment].item[=].item[+].linkId = "C5_SevereNausea"
* item[nursingAssessment].item[=].item[=].text = "Ernstige misselijkheid (dwz misselijkheid met onvoldoende orale intake)"
* item[nursingAssessment].item[=].item[=].type = #choice
* item[nursingAssessment].item[=].item[=].required = true
* item[nursingAssessment].item[=].item[=].code = $sct#73335002 "Increased nausea and vomiting"
* item[nursingAssessment].item[=].item[=].answerOption[0].valueCoding = $sct#373066001 "Yes"
* item[nursingAssessment].item[=].item[=].answerOption[+].valueCoding = $sct#373067005 "No"

* item[nursingAssessment].item[=].item[+].linkId = "C6_SevereDyspnea"
* item[nursingAssessment].item[=].item[=].text = "Toegenomen kortademigheid en/of ernstige kortademigheid (dwz kortademigheid in rust/zonder inspanning en/of kortademigheid die hindert bij de dagelijkse activiteiten) (Trastuzumab, Azacitidine)"
* item[nursingAssessment].item[=].item[=].type = #choice
* item[nursingAssessment].item[=].item[=].required = true
...
* item[nursingAssessment].item[=].item[+].linkId = "C7_NewCoughDyspnea"
* item[nursingAssessment].item[=].item[=].text = "Nieuwe of toegenomen productieve of droge hoest, met of zonder dyspnoe"
* item[nursingAssessment].item[=].item[=].type = #choice
* item[nursingAssessment].item[=].item[=].required = true
* item[nursingAssessment].item[=].item[=].code = $sct#11833005 "Dry cough"
* item[nursingAssessment].item[=].item[=].answerOption[0].valueCoding = $sct#373066001 "Yes"
* item[nursingAssessment].item[=].item[=].answerOption[+].valueCoding = $sct#373067005 "No"

* item[nursingAssessment].item[=].item[+].linkId = "C8_GeneralDecline"
* item[nursingAssessment].item[=].item[=].text = "Algemene achteruitgang"
* item[nursingAssessment].item[=].item[=].type = #choice
* item[nursingAssessment].item[=].item[=].required = true
* item[nursingAssessment].item[=].item[=].code = $sct#154091000119106 "Decline in functional status"
* item[nursingAssessment].item[=].item[=].answerOption[0].valueCoding = $sct#373066001 "Yes"
* item[nursingAssessment].item[=].item[=].answerOption[+].valueCoding = $sct#373067005 "No"

* item[nursingAssessment].item[=].item[+].linkId = "C9_Other"
* item[nursingAssessment].item[=].item[=].text = "Andere: (indien van toepassing)"
* item[nursingAssessment].item[=].item[=].type = #string
* item[nursingAssessment].item[=].item[=].code = $sct#438833006 "Administration of drug or medicament contraindicated"

* item[nursingAssessment].item[=].item[+].linkId = "C10_ContactCareTeam"
...
* item[nursingAssessment].item[=].item[+].linkId = "C11_Decision"
...
* item[nursingAssessment].item[=].item[+].linkId = "C12_DecisionSpecify"
...
* item[nursingAssessment].item[=].item[=].enableWhen[0].question = "C11_Decision"
* item[nursingAssessment].item[=].item[=].enableWhen[0].operator = #=
