...
* item[nursingAssessment].item[premedicationIntake].item[premedicationCorrect].answerValueSet = Canonical(YesNoVS)
...
* item[nursingAssessment].item[contraindications].item[premedicationNotTaken].answerValueSet = Canonical(YesNoVS)
...
* item[nursingAssessment].item[symptomBurden].item[muscleAndJointPain].answerValueSet = Canonical(ONCOSymptomGradeVS)
